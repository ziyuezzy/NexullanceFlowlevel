...
ddf_configs=[config for config in gl.ddf_configs if config[0]<200]
slimfly_configs=[config for config in gl.sf_configs if config[0]<200]
polarfly_configs=[config for config in gl.pf_regular_configs if config[0]<200]
