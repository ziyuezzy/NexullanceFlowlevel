...
from Nexullance_IT_cpp import Nexullance_IT_interface, Nexullance_IT_fast_interface
...
# print("traffic demand matrix prepared:")
# print(M_EPs)

print("starting nexullance_IT test...")
nexu_it = Nexullance_IT_interface(V, arcs, 10.0, 10.0, False)
nexu_it.set_parameters(0.1, 7.0, 0.00001, 5, 1000000, V*2, False)
nexu_it_result = nexu_it.run_IT(M_EPs, EPR)

print("====== original nexu_IT ======")
print("elasped_time [s]: ", nexu_it_result.get_elapsed_time())
print("max_load: ", nexu_it_result.get_max_core_link_load())
print("phi: ", nexu_it_result.get_phi())
print("num_attempts: ", nexu_it_result.get_num_attempts())
